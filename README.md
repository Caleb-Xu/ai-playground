...
├── .github/
│   └── agents/
│       ├── 教程中枢.agent.md      # 中央知识库和工作流中枢
│       ├── 实践导师.agent.md      # 快速编码和问题解决
│       └── 复盘导师.agent.md      # 深度讲解和原理阐述
...
### 2025-12-26: 三角色 Agent 工作流系统

**新增功能**:
- ✅ 教程中枢 (Central Hub) - 知识库和工作流管理
- ✅ 实践导师 (Practitioner) - 快速编码和问题解决
- ✅ 复盘导师 (Reviewer) - 深度讲解和原理阐述
- ✅ Handoffs 按钮 - 角色一键切换

**三角色工作流**:
| 角色 | 职责 | 何时选择 |
|------|------|--------|
| **教程中枢** | 项目全景、知识库、进度追踪 | 需要查看学习规划和共享资源 |
| **实践导师** | 快速编码、修复 bug、功能实现 | 准备开始迭代或遇到代码问题 |
| **复盘导师** | 原理讲解、概念深化、最佳实践 | 想深度理解某个技术概念 |
